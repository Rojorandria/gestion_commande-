<?php 
    ...
    if(isset($_POST['addimage'])){
        $dataimage = [
            'img_link' => 'image/' . $_FVIILES['image']['name'],
        ...
        $addimage =$dbrequest->prepare("INSERT INTO vendeur(nomvend,prenomvend,telephone,image) VALUES (:nom , :prenom, :telephone, :img_link)");
